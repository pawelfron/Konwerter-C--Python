...
public partial class CGrammarBaseListener : ICGrammarListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterRvalue([NotNull] CGrammarParser.RvalueContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="CGrammarParser.rvalue"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitRvalue([NotNull] CGrammarParser.RvalueContext context) { }
	/// <summary>
